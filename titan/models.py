...
class drug(models.Model):
    drugid = models.IntegerField(unique = True, null=False,primary_key=True, editable=False,default='')
    drugname = models.CharField(verbose_name='Drug Name',max_length=30, unique=True, null=False,default='')
...
class triple(models.Model):
    npi = models.ForeignKey(prescriber, verbose_name=("Prescriber"), on_delete=models.CASCADE, null=False,primary_key=True,default='')
    drugname = models.ForeignKey(drug, verbose_name=("DrugName"), on_delete=models.CASCADE, null=False,default='')
...
class link(models.Model):
    npi = models.ForeignKey(prescriber, verbose_name=("NPI"), on_delete=models.CASCADE, null=False,primary_key=True,default='')
    cred_id = models.ForeignKey(credential, verbose_name=("Credential_id"), on_delete=models.CASCADE, null=False,default='')
